  ...
  const registrationDate = new Date(userData.user.created_at).toLocaleDateString()
    ...
    return (
        ...
        <div className="card shadow mb-4">
            ...
            <div className="card-body d-flex flex-column justify-content-center align-items-center">
                <div className="text-center">
                    <img className="img-fluid px-3 px-sm-4 mt-3 mb-4" style={{width: 40 +'rem'}} src={userData.userImage} alt=" User"/>
                </div>
        ...
        <p className="card-text text-center">Fecha de Registro: {registrationDate}</p>
                <a className="btn btn-danger" target="_blank" rel="nofollow" href="/UserStats">View User detail</a>
            </div>
        </div>
    </div>
    )
